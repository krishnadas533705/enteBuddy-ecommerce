...
const LoginModel = ({onClose}) => { 
  ...
  return (
    <div ref={modalRef} onClick= {closeModal} className="z-10 text-white fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex items-center justify-center">
        <div  className='flex flex-col '>
        <div id="recaptcha-container" ></div>
        <Toaster toastOptions={{ duration: 4000  }} />
            <button onClick={onClose} className='place-self-end'><IoCloseCircleOutline/></button>
            <div className={`border border-blue-100 py-10 px-10  bg-hero bg-cover rounded-xl flex flex-col gap-5 mx-3 `}>
                
                <h1  className="text-3xl font-jaro text-yellow-300  text-center ">Login through otp</h1>
