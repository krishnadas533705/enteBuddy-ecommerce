      ...
      <div className="flex flex-col m-4   text-white p-5 bg-hero2 bg-contain bg-tertiary w-full md:w-1/4 h-2/4 rounded-3xl font-poppins">
        ...
        {isVerified ? (
          <div className="cursor-pointer flex justify-center">
            <div
              onClick={onClose}
              className="py-2 px-4 bg-primary text-black font-medium text-lg rounded-lg mr-2"
            >
              yes
            </div>
            <div
              onClick={() => setIsVerified(false)}
              className="py-2 px-4 bg-primary text-black font-medium text-lg rounded-lg"
            >
              no
            </div>{" "}
          </div>
          ...
          <>
            <div className="flex flex-col justify-center items-center">
              <div>Try again when you are older .</div>
              <button
                onClick={() => setIsVerified(true)}
                className="mt-5 bg-primary py-2 px-4 rounded-2xl text-black font-medium"
              >
